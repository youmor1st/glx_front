...
export default function TopMarketSelectDrawer() {
  ...
  return (
    ...
    >
      <DrawerTrigger asChild>
        <FilterButton active={!!form.watch("marketCap")} title="Top Market" />
      </DrawerTrigger>
                        ...
                        >
                          <>
                            <RangeSelectCardRadio
                              form={form}
                              value={"custom"}
                              selected={form.watch("marketCap") === "custom"}
                            ></RangeSelectCardRadio>
                            {[
                              ["Micro Cap ($500K – $5M)", "micro"],
                              ["Small Cap ($5M – $20M)", "small"],
                              ["Mid Cap ($20M – $50M)", "mid"],
                              ["Large Cap ($50M – $200M)", "large"],
                              ["Mega Cap ($200M – $2B)", "mega"],
                            ].map(([label, value]) => (
                              <RadioSelectCard
                                key={value}
                                label={label}
